...
OutputBaseFilename=perso4_setup


[Files]
Source: "perso.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\Documents\perso\share\*"; DestDir: "{app}\share"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: "D:\Documents\perso\dll32\*.dll"; DestDir: "{app}"; Flags: ignoreversion
; NOTE: Don't use "Flags: ignoreversion" on any shared system files

[Icons]
Name: "{commonprograms}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}";IconFilename: "{app}\fichiers\glade\Images\add.ico"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon;IconFilename: "{app}\fichiers\glade\Images\add.ico"
